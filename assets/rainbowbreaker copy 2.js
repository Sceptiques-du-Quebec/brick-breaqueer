...
export default class RainbowBreaker extends Phaser.Scene {
    constructor() {
        ...
        // Ordre des niveaux mis à jour et données nettoyées
        this.FLAGS = [
            { 
                id: "flag_trans", 
    ...
    loadLevel(i) {
        ...
        for (let r = 0; r < rows; r++) {
            for (let c = 0; c < cols; c++) {
                ...
                // On garde une couleur par défaut pour les particules (arc-en-ciel)
    ...
    gameOver() {
        ...
        const sub = this.add.text(this.gameWidth / 2, displayY + 70, "ENTRÉE POUR RÉESSAYER", { 
            fontFamily: this.SYSTEM_FONT, fontSize: "18px", color: "#000", fontWeight: "900" 
        }).setOrigin(0.5);
